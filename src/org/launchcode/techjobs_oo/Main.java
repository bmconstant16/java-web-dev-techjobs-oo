...
//        Job fakeJobTest = new Job("", new Employer("ACME"), new Location("Desert"), new PositionType("Quality control"), new CoreCompetency("Persistence"));
        //System.out.println(fakeJob.getClass().getSimpleName());
//        System.out.println(fakeJobTest);
